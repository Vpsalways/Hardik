...
TOKEN = '7245792065:AAHoxiqc2EoeFsXik3U7GVImF1XPFCxkOAw'
MONGO_URI = 'mongodb+srv://Bishal:Bishal@bishal.dffybpx.mongodb.net/?retryWrites=true&w=majority&appName=Bishal'
FORWARD_CHANNEL_ID = -1002185644550
CHANNEL_ID = -10022185644550
error_channel_id = -1002185644550
...
def handle_message(message):
    ...
    if message.text == "Instant Plan 🧡":
        ...
        bot.send_message(message.chat.id, "*Please use the following link for Canary Download: HACKINGANDROID*", parse_mode='Markdown')
